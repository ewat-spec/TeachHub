...
export default function TrainerDashboardPage() {
  const summaryCards = [
    { title: "My Profile", icon: <UserCircle2 className="h-6 w-6 text-primary" />, description: "Manage your personal and professional details.", link: "/trainer/profile" },
    { title: "My Schedule", icon: <CalendarDays className="h-6 w-6 text-primary" />, description: "View and manage your scheduled classes.", link: "/trainer/schedule" },
    { title: "My Lesson Plans", icon: <BookOpenText className="h-6 w-6 text-primary" />, description: "Create, view, and update your lesson plans.", link: "/trainer/lesson-plans" },
    { title: "My Notifications", icon: <Bell className="h-6 w-6 text-primary" />, description: "Check your latest notifications and reminders.", link: "/trainer/notifications" },
  ];
       ...
       <Card className="mt-8 shadow-lg">
        ...
        <CardContent>
          <p className="text-muted-foreground mb-4">
            Welcome to your TeachHub trainer portal! Navigate through the sections using the sidebar to access different features.
