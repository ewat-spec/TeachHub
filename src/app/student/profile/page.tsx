...
import { CheckCircle, Upload, Edit3 } from "lucide-react";
  ...
  const handleProfilePicChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        ...
        form.setValue("profilePicUrl", reader.result as string, { shouldValidate: true }); // Storing as data URL for mock
      };
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          <Card className="shadow-xl">
            <CardHeader>
              <CardTitle className="font-headline flex items-center"><Edit3 className="mr-2 h-6 w-6 text-primary"/>Edit Your Profile</CardTitle>
