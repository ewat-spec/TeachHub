...
import { ProductIcon, HomeIcon, AutomotiveIcon, ShapesIcon } from './icons';
...
export const ModeSelector: React.FC<ModeSelectorProps> = ({ setDesignMode }) => {
    const modes = [
        ...
        { id: 'basic-geometry', name: 'Basic Geometry (Orthographic)', icon: ShapesIcon, description: 'Create and visualize simple geometric shapes in 3D and orthographic views.' },
    ];
    return (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {modes.map((mode) => (
                        <button
                            ...
                            className="bg-slate-800 p-6 rounded-lg border border-slate-700 hover:border-sky-500 hover:bg-slate-700/50 transition-all duration-300 text-left flex flex-col items-start h-full"
                        >
